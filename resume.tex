...
\headedsection  % sets the header for the section and includes any subsections
  ...
  \headedsubsection
    {Postdoctoral Fellow}
    {Apr \apo17 -- present}
    {\bodytext{Developing computational methods for analyzing single cell transcriptomics data of immune cells in the context of viral infection. Fellow in the Viral Immunology Systems Program.}}
}

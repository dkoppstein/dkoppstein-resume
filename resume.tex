...
\textsmaller{}+61 4 8830 3039\sbull Skype: david.koppstein
\vspace{0.05in}
...
\headedsection  % sets the header for the section and includes any subsections
  ...
  \headedsubsection
    {Postdoctoral Fellow}
    {Apr \apo17 -- present}
    {\bodytext{Developing computational methods for analyzing single-cell transcriptomics data of immune cells in the context of viral infection, including immune receptor reconstruction using VDJPuzzle. Mentoring two Ph.D students and one honors student. }}
}
...
{\noindent Dale R, Gruning B, Sjodin A, Rowe J, Chapman BA, Tomkins-Tinch CH, Valieris R, \textbf{Koppstein D}, The Bioconda Team, Koster J. Bioconda: A sustainable and comprehensive software distribution for the life sciences. 2017. \textit{bioRxiv}.} \vspace{0.4em} \\
...
\spacedhrule{0.3em}{-0.4em}  % a horizontal line with some vertical spacing before and after
